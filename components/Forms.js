...
export default function Form(){
    ...
    const disclaimer = words + <a href="https://corporate.exxonmobil.com/Global-legal-pages/privacy-policy" rel="noreferrer">ExxonMobil privacy policy. </a>
    return(
        <div>
            <form name="submit-to-google-sheet">
                ...
                <input type="checkbox" id="OPTin" name="OPTin"/> {disclaimer}
              <br/>
